...
class AnimeDetailsScreen extends StatefulWidget {
  ...
  const AnimeDetailsScreen({Key? key, required this.animeData})
      : super(key: key);
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (user != null) {
                    ...
                    await AuthService().addAnimeToWatchlist(userId, animeId);
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AnimeDetailsWithRemoveScreen(
